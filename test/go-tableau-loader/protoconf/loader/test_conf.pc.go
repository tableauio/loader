...
// OrderedMap types.
type ActivityConf_int32_OrderedMap = treemap.Map[uint32, int32]

type Uint32_Section_OrderedMapValue = pair.Pair[*ActivityConf_int32_OrderedMap, *protoconf.Section]
type Uint32_Section_OrderedMap = treemap.Map[uint32, Uint32_Section_OrderedMapValue]
...
type ActivityConf_Activity_Chapter_OrderedMap = treemap.Map[uint32, ActivityConf_Activity_Chapter_OrderedMapValue]
...
type ActivityConf_Activity_OrderedMap = treemap.Map[uint64, ActivityConf_Activity_OrderedMapValue]

...
func (h *baseHub) GetHeroConf() *HeroConf {
	return h.getMessagerContainer().heroConf
}

func (h *baseHub) GetHeroBaseConf() *HeroBaseConf {
	return h.getMessagerContainer().heroBaseConf
}

func (h *baseHub) GetItemConf() *ItemConf {
	return h.getMessagerContainer().itemConf
}

func (h *baseHub) GetPatchReplaceConf() *PatchReplaceConf {
	return h.getMessagerContainer().patchReplaceConf
}

func (h *baseHub) GetPatchMergeConf() *PatchMergeConf {
	return h.getMessagerContainer().patchMergeConf
}

func (h *baseHub) GetRecursivePatchConf() *RecursivePatchConf {
	return h.getMessagerContainer().recursivePatchConf
}

func (h *baseHub) GetActivityConf() *ActivityConf {
	return h.getMessagerContainer().activityConf
}

func (h *baseHub) GetChapterConf() *ChapterConf {
	return h.getMessagerContainer().chapterConf
}

func (h *baseHub) GetThemeConf() *ThemeConf {
	return h.getMessagerContainer().themeConf
}

func (h *baseHub) GetTaskConf() *TaskConf {
